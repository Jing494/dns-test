...
![Version: v2026.08.30](https://img.shields.io/badge/Version-v2026.08.30-blue.svg)
...
├── tests/                          # 单元测试（perl 18 + bash 9 + 4 + 19 + 13 + 125 + 56 + 23 + 83 用例，共 350）
...
#   下载 dns-test-v2026.08.30.tar.gz 后解压即可
